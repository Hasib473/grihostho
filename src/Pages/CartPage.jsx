            ...
            {cartItems.length === 0 ? (
                <div className="mt-8 rounded-lg border border-slate-200 bg-white px-5 py-12 text-center">
                    ...
                    <p className="mt-2 text-sm text-slate-500">
                        Add products from the details page to see them here.
                    </p>
                        ...
                        {cartItems.map((item) => (
                            ...
                            >
                                <div className="grid gap-4 sm:grid-cols-[96px_minmax(0,1fr)_auto] sm:items-center">
                                    ...
                                    {/* IMAGE (NEW FEATURE) */}
                                    <div className="h-24 w-24 overflow-hidden rounded-md bg-[#fff4ea] flex items-center justify-center">
                                        {item.image ? (
                                            <img
                                                src={item.image}
                                                alt={item.product}
                                    ...
                                    <div className="min-w-0">
                                        <h2 className="break-words text-lg font-bold text-[#07162b]">
                                            {item.product}
                                        </h2>
                                    ...
                                    <div className="flex flex-row flex-wrap items-center justify-between gap-3 sm:flex-col sm:items-end sm:justify-start">
                                        <p className="text-lg font-bold text-[#07162b]">
                                        ...
                                        <div className="flex overflow-hidden rounded-md border border-slate-300">
                                            ...
                                            <span className="flex h-9 w-11 items-center justify-center bg-white text-sm font-bold text-[#07162b]">
                                                {item.quantity}
                                            </span>
                    ...
                    <aside className="h-fit rounded-lg border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
                        ...
                        <div className="mt-5 space-y-3 text-sm">
                            <div className="flex justify-between text-slate-600">
                                ...
                                <span className="font-semibold text-[#07162b]">
                                    {cartCount}
                                </span>
                            </div>
